...
CREATE TABLE "at_voice_terminations" (
	...
	"voice_numbering_plan_destination_id" uuid,
	"name" text NOT NULL,
	...
	CONSTRAINT "at_voice_terminations_destination_required_when_generated" CHECK (("at_voice_terminations"."type" = 'generated' AND "at_voice_terminations"."voice_numbering_plan_destination_id" IS NOT NULL) OR ("at_voice_terminations"."type" = 'assigned' AND "at_voice_terminations"."voice_numbering_plan_destination_id" IS NULL)),
